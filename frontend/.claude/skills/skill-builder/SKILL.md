...
A complete, worked example — the `express-crud-generator` skill with real frontmatter,
workflow, rules, checklist, and error handling — lives in
[`references/example.md`](references/example.md). Read it as a copy-paste starting
template when drafting a new skill.