...
export const departmentLabels: Record<WorkspaceLanguage, Record<string, string>> = {
  ...
  vi: {
    ...
    FDS_OPS: 'FDS Ops',
    FDS_OPS_CUSTOMS: 'FDS Ops Hải quan',
    FDS_SALES: 'FDS Sales',
    Finance: 'Tài chính',
...
export const statusLabels: Record<WorkspaceLanguage, Record<string, string>> = {
  en: {
    ...
    PICKED_UP: 'Picked up',
    PENDING: 'Pending',
    PENDING_ADJUSTMENT: 'In price negotiation',
  ...
  vi: {
    ...
    PENDING: 'Đang chờ',
    PENDING_ADJUSTMENT: 'Đang đàm phán giá',
    PENDING_APPROVAL: 'Chờ duyệt',
    PENDING_CONFIG: 'Chờ cấu hình',
    POD_RECEIVED: 'Đã nhận POD',
    PRELIMINARY_SENT: 'Đã gửi sơ bộ',
    PROCUREMENT: 'Đặt hàng',
    PRODUCTION: 'Sản xuất',
    QUOTE_CONFIRMED: 'Đã xác nhận báo giá',
    QUOTE_PENDING: 'Chờ báo giá',
    QUOTED: 'Đã báo giá',
