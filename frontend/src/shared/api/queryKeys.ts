export const queryKeys = {
  ...
  containerTypeDetail: (id: string) => ['container-types', 'detail', id] as const,
  containerTypeLists: ['container-types'] as const,
  containerTypes: (params: Record<string, unknown>) => ['container-types', params] as const,
  ...
  quotationOptions: (id: string) => ['quotations', id, 'options'] as const,
  quotationRequests: ['quotation-requests'] as const,
  quotationRequestLists: ['quotation-requests', 'list'] as const,
  quotationRequestsList: (params: Record<string, unknown>) => ['quotation-requests', 'list', params] as const,
  quotationRequestDetail: (id: string) => ['quotation-requests', 'detail', id] as const,
