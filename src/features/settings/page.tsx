...
import { IconBulb, IconLanguage, IconPalette, IconPlus, IconSettings, IconShieldLock, IconUserCircle, IconUsers } from '@tabler/icons-react';
...
export function Settings() {
  ...
  const visualThemeOptions = useMemo(
    () =>
      (['standard', 'high-contrast', 'blue-sight', 'yellow-sight'] as VisualTheme[]).map((theme) => ({
  ...
  const densityOptions = useMemo(
    () =>
      (['standard', 'compact'] as DensityPreference[]).map((value) => ({
    ...
    <Stack gap="lg">
      ...
      >
        ...
        <Tabs.Panel value="preferences" pt="lg">
          <Stack gap="lg">
            <Alert icon={<IconBulb size={18} />} title={t('settings.themeSystem')}>
            ...
            <SimpleGrid cols={{ base: 1, md: 2, xl: 4 }}>
              ...
              <Paper withBorder p="lg">
                <Stack gap="sm">
                  ...
                  <Select
                    data={visualThemeOptions}
                    value={visualTheme}
                    onChange={(value) => setVisualTheme((value ?? 'standard') as VisualTheme)}
                  />
                  <Text c="dimmed" size="sm">
