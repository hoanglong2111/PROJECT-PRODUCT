...
import type { PurchaseOrder, PurchaseOrderLineItem, PurchaseRequest } from '../domain/logistics';
import { pool } from '../config/database';
import { ApiError } from '../utils/errors';
import type { CreatePurchaseOrderBody, TokenPayload } from '../domain/types';
import {
  appendUnique,
